      ...
      <section className="hero shell home-hero">
        ...
        <div className="hero-visual" aria-label="Pawly real outing review preview">
          ...
          <div className="device-card outing-card">
            ...
            <div className="camera-scene"><img className="hero-puppy-art" src="/pawly-german-shepherd-room.png" alt="A German Shepherd puppy resting calmly on a rug" /><div className="camera-scene-shade" /><div className="calm-label"><span>●</span><div><strong>Dog visible</strong><small>92% confidence</small></div></div><div className="scene-sound">♪ Sound on</div></div>
