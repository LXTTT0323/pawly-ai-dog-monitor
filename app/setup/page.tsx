  ...
  return (
    <main className="app-shell">
      ...
      <section className="setup-wrap shell">
        <div className="setup-intro"><span className="eyebrow">Private beta setup</span><h1>One room.<br />Two screens.</h1><p>Any spare phone, tablet, or computer becomes the camera. Your other device becomes the quiet dashboard. The 12-character room key is the only way into this beta room—treat it like a password.</p></div>
        <div className="setup-panel">
          <div className="setup-step"><span>1</span><div><h2>Open camera mode</h2><p>Use a modern browser, allow camera access, then keep the page visible. Microphone access is optional.</p><div className="room-code">{roomCode || "••••••••••••"}</div><div className="button-row"><a className="button button-primary" href={cameraUrl}>Open camera on this device</a><button className="button button-ghost" onClick={() => navigator.clipboard.writeText(cameraUrl)}>Copy camera link</button></div></div></div>
